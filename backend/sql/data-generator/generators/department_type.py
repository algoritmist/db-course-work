    ...
    return [
        DepartmentType(0, "Отдел менеджмента", '''
                       Осуществляет обработку заявок от пользователей и проверяет обязательное условие
                        для выполнения заявки – продажа души Мефистофелю'''),
        DepartmentType(1, "Отдел продавцов", '''
                       ...
                       Если средств у пользователя достаточно, отправляются заявки в финансовый и транспортный отделы'''),
        DepartmentType(2, "Отдел поиска людей", '''
                       Этот отдел отвечает за поиск людей, местоположение которых полностью не известно. 
                       Поиск может осуществляться как в стране проживания этого человека, если она известна, так и по всему миру.'''),
        DepartmentType(3, "Финансовый отдел", '''
                       Списывает сумму с заказчика и предоставляет средства отделу, передавшему заявку.'''),
        DepartmentType(4, "Торговый отдел", '''
                       Продаёт пользователю предметы из склада компании.
                       Он формируется за счет военных кампаний пользователей, которые сотрудничают с военным отделом компании'''),
